    ...
    <div className="max-w-md mx-auto px-4 pt-6">
      ...
      <div className="bg-bg-card border border-border rounded-2xl px-5 py-5 mb-4 animate-slide-up">
        ...
        <div className="mb-3">
          ...
          <textarea
            value={bio}
            onChange={(e) => updateField('bio', e.target.value, setBio)}
        ...
        <div className="mb-3">
          ...
          <input
            value={clubs}
            onChange={(e) => updateField('clubs', e.target.value, setClubs)}
            placeholder="e.g. SBU Hacks, CEAS"
        ...
        <div className="mb-3">
          ...
          <select
            value={residenceHall}
            onChange={(e) => updateField('residence_hall', e.target.value, setResidenceHall)}
            className={inputClass}
          >
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => updateField('relationship_status', e.target.value, setRelationshipStatus)}
            className={inputClass}
          >
